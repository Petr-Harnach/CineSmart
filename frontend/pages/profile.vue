      ...
      <div class="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1 space-y-8">
          ...
          <div class="bg-white/5 dark:bg-gray-900/60 backdrop-blur-xl rounded-xl shadow-xl border border-gray-200 dark:border-gray-700/50 overflow-hidden p-2">
            ...
            <div class="flex items-center justify-between px-4 py-3 rounded-lg hover:bg-white/10 text-gray-300 hover:text-white transition-all group">
              <div class="flex items-center gap-3">
                <div class="p-1.5 bg-gray-800 rounded-md text-gray-400 group-hover:text-green-400 group-hover:bg-gray-700 transition-colors">
              ...
              <span class="text-xs font-bold bg-gray-800 text-gray-400 px-2 py-0.5 rounded-md">{{ reviewCount }}</span>
            </div>
          </div>
